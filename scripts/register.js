alert( <?php echo "\"Hello\""; ?> );alert( <?php echo "\"Hello\""; ?> );alert( <?php echo "\"Hello\""; ?> );alert( <?php echo "\"Hello\""; ?> );alert( <?php echo "\"Hello\""; ?> );$(function(){
	//上传封面
	var clipArea = new bjj.PhotoClip("#clipArea", {
		size: [428, 321],// 截取框的宽和高组成的数组。默认值为[260,260]
		outputSize: [428, 321], // 输出图像的宽和高组成的数组。默认值为[0,0]，表示输出图像原始大小
//		outputType: "gif", // 指定输出图片的类型，可选 "jpg" 和 "png" 两种种类型，默认为 "jpg"
